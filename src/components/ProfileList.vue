...
<template>
    <div class="profile_list">
        <h2 class="featured_title bg-white p-3 w-100 text-center py-3 mb-2"><strong> Featured Doctors </strong> </h2>
        <div id="card_doctor" class="container position-relative py-5">

            <!-- buttons -->
            <div class="buttons d-flex w-100 justify-content-center gap-3">
                <div @click="prevSlide" class="bg_opacity p-3 rounded-circle text-white">
                    <i class="fa-sharp fa-solid fa-arrow-left "></i>
                </div>
                <div @click="nextSlide" class="bg_opacity p-3 rounded-circle text-white">
                    <i class="fa-sharp fa-solid fa-arrow-right "></i>
                </div>
            </div>
            <div v-if="!isMobile">
                <div class="row row-cols-1 flex-md-row row-cols-md-3 position-relative">
            ...
            <div v-else>
                <div class="row row-cols-1 flex-md-row row-cols-md-3 position-relative">
                    <div v-for="(profile, index) in [store.profiles[currentSlide]]" :key="index" class="col my-3">
