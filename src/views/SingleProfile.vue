      ...
      <div class="col-12 bg-light-gray mt-5 shadow-lg rounded-4 p-4">
        <div class="d-flex flex-wrap align-items-center">
          ...
          <div class="flex-grow-1">
            ...
            <p class="mb-1"><strong>Phone number: </strong>{{ store.singleProfile.phone_number }}</p>
            <p class="mb-1"><strong>Address: </strong>{{ store.singleProfile.address }}</p>
            <p class="mb-1"><strong>Doctor email: </strong> {{ store.user.email }}</p>
            <p class="mb-1"><strong>About this doctor: </strong> {{ store.singleProfile.performances }}</p>
